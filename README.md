...
> **Note on Geocoding Optimization:** To import all 8,000+ records without violating Nominatim rate limits or taking hours, the bulk loader uses an optimized lookup strategy combining state centroids with a deterministic city-name hashing algorithm.
